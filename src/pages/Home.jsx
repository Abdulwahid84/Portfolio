  ...
  const roles = [
    {
      ...
      desc: "Building intelligent AI-powered solutions",
    },
    {
      icon: FaPython,
      title: "Python Developer",
      desc: "Developing scalable backend systems",
    },
    {
      icon: FaRobot,
      title: "Machine Learning",
      desc: "Training and optimizing ML models",
    },
    {
      icon: FaDatabase,
      title: "Data Science",
      desc: "Data analysis & predictive systems",
    },
    {
      icon: FaShieldAlt,
      title: "Cybersecurity",
      desc: "Phishing detection & secure systems",
    },
    {
      icon: FaGraduationCap,
      title: "Research Enthusiast",
      desc: "Exploring innovative AI technologies",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 pb-12 sm:pb-16 md:pb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-start pt-14">
          ...
          <div className="flex flex-col justify-center text-center md:text-left">
            ...
            >
              I'm a passionate{" "}
              <span className="font-semibold">AI/ML Developer</span>{" "}
              specializing in building intelligent and data-driven applications.
              I enjoy developing real-world machine learning solutions using{" "}
              <span className="font-semibold">Python</span>,{" "}
              <span className="font-semibold">Scikit-learn</span>, and{" "}
              <span className="font-semibold">TensorFlow</span>. Beyond AI, I
              explore{" "}
              <span className="font-semibold">backend development</span>,{" "}
              <span className="font-semibold">Data Science</span>, and{" "}
              <span className="font-semibold">Cybersecurity</span>, while
