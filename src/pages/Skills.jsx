...
const categories = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "EDA", level: 82, icon: "📈" },
      { name: "Feature Engineering", level: 84, icon: "⚙️" },
    ],
  },
  {
    title: "Backend & Tools",
    skills: [
      { name: "REST APIs", level: 86, icon: "🔗" },
      { name: "Git & GitHub", level: 90, icon: "🐙" },
      { name: "Docker", level: 75, icon: "🐳" },
      { name: "Kubernetes", level: 68, icon: "☸️" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Phishing Detection", level: 88, icon: "🛡️" },
      { name: "Recommendation Systems", level: 82, icon: "🎯" },
      { name: "Model Evaluation", level: 86, icon: "📉" },
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-blue-500 to-blue-600 bg-clip-text text-transparent mb-4 leading-snug pt-4">
            My Skills
          </h1>
          ...
          <p className={`text-lg md:text-xl ${textPrimary} max-w-3xl mx-auto`}>
            ...
            Intelligence, Machine Learning, Data Science, and Backend
            Development.
          </p>
        </div>
        ...
        >
          ...
          <p className={`text-lg mb-8 ${textPrimary}`}>
            Technology evolves rapidly, and so do I. I'm continuously learning
            advanced AI technologies, improving my machine learning expertise,
            and exploring scalable cloud-based systems to build impactful
